...
describe('GET ALL BLOGS SUPERADMIN', () => {
  ...
  it('should return paginated blogs for superadmin', async () => {
  ...
  it('should return 401 without basic auth', async () => {
    await request(httpServer).get('/sa/blogs').expect(HTTP_STATUS.UNAUTHORIZED_401);
  });
});
